class quickSort{ 
  ...
  // return array if it there is only one or zero elements
    ...
    //iterating through the array, comparing the element at index to pivot, with numbers less than pivot going to the left, and the numbers whose value is more than pivot's to the right
